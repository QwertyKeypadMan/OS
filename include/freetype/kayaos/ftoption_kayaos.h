/* === KAYAOS PATCH NOTES ===
 * Bu dosya FreeType'in orijinal ftoption.h dosyasindan turetilmistir.
 * Sadece asagidaki makrolar KAPATILDI (KAYAOS: disabled etiketiyle isaretli):
 *   - FT_CONFIG_OPTION_ENVIRONMENT_PROPERTIES (getenv() -> kernelde yok)
 *   - FT_CONFIG_OPTION_USE_ZLIB / woff sikistirma (zlib portlanmadi)
 *   - FT_CONFIG_OPTION_MAC_FONTS (gereksiz)
 *   - FT_CONFIG_OPTION_SVG (OT-SVG renderer, gereksiz + libsvg gerektirir)
 *   - TT_CONFIG_OPTION_BYTECODE_INTERPRETER (v1: setjmp/longjmp tabanli VM
 *     baslangicta devre disi, unhinted + smooth AA yeterli; sonra acilabilir)
 * ========================== */
...
FT_BEGIN_HEADER
   ...
   *
   */
/* KAYAOS: disabled -- #define FT_CONFIG_OPTION_ENVIRONMENT_PROPERTIES */
  /**************************************************************************
   *
...
#define FT_CONFIG_OPTION_USE_LZW
   ...
   */
/* KAYAOS: disabled -- #define FT_CONFIG_OPTION_USE_ZLIB */
  /**************************************************************************
   *
...
#define FT_CONFIG_OPTION_ADOBE_GLYPH_LIST
   ...
   */
/* KAYAOS: disabled -- #define FT_CONFIG_OPTION_MAC_FONTS */
  /**************************************************************************
   *
...
#undef FT_CONFIG_OPTION_USE_MODULE_ERRORS
   ...
   */
/* KAYAOS: disabled -- #define FT_CONFIG_OPTION_SVG */
  /**************************************************************************
   *
   * Error Strings
   *
...
#define TT_CONFIG_CMAP_FORMAT_14
   ...
   * for certain configurations only.
   */
/* KAYAOS: disabled -- #define TT_CONFIG_OPTION_BYTECODE_INTERPRETER */
  /**************************************************************************
   *
...
#undef TT_CONFIG_OPTION_COMPONENT_OFFSET_SCALED
   ...
   */
/* KAYAOS: disabled -- ftmm.c vendor'lanmadi, FT_Set_Named_Instance linker hatasi verir
